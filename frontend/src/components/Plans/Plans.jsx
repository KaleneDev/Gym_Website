                ...
                <div className="plans__container__cards">
                    <SlideInFromLeft duration='1.5'>
                        <div className="plans__container__cards__card">
                            ...
                            <div>
                                <span>
                                    <img src={whiteTick} alt="" /> 2 hours of
                                    excercises
                                </span>
                                <span>
                                    <img src={whiteTick} alt="" /> Free
                                    consultaion to coaches
                                </span>
                                <span>
                                    <img src={whiteTick} alt="" /> Access to The
                                    Community
                                </span>
                            </div>
                            <div>
                    ...
                    <SlideInFromTop duration='1.5'>
                        <div className="plans__container__cards__card premium">
                            ...
                            <div>
                                <span>
                                    <img src={whiteTick} alt="" /> 5 hours of
                                    excercises
                                </span>
                                <span>
                                    <img src={whiteTick} alt="" /> Free
                                ...
                                <span>
                                    <img src={whiteTick} alt="" /> Accessto
                                    minibar
                                </span>
                            </div>
                            <div>
                    ...
                    <SlideInFromRight duration='1.5'>
                        <div className="plans__container__cards__card">
                            ...
                            <div>
                                <span>
                                    <img src={whiteTick} alt="" /> 8 hours of
                                    excercises
                                </span>
                                <span>
                                    <img src={whiteTick} alt="" /> Consultation
                                    of Private Coach
                                </span>
                                <span>
                                    <img src={whiteTick} alt="" /> Free Fitness
                                    Merchandises
                                </span>
                            </div>
                            <div>
